...
package com.vesoft.nebula.ngqlbuilder.query.cypher;
...
import com.vesoft.nebula.ngqlbuilder.exception.DataTypeException;
...
public class Encoding {
    ...
    public static String joinTag(Map<String,
        ...
        StringBuffer tagPartFormat = new StringBuffer();
    ...
    /**
     * use parameter to connect an attribute values of relationship.
     *
